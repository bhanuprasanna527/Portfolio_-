const projectsData = [
  ...
  },
  {
    ...
    description:
      'Introducing Flash Chat, the messaging app to connect with others in a flash! Developed using Flutter and Firebase, the app ensures secure messaging by using cryptography algorithms. Say hello to the world of exciting chats with Flash Chat!',
