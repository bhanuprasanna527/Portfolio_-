...
draft: false
summary: Moving cards on tailwind website
images: []
layout: PostSimple
---
...
```js showLineNumbers
<div
  className={`card-container min-w-lg max-w-lg rounded-b-md rounded-t-md shadow-lg ${Styles.scrollBg} rotate-12 transform`}
>
  <div className="top-text p-8">
    ...
    <div className="container-text max-w-lg">
      <p className="py-8 text-xl font-semibold text-gray-900">
        As seen on the tailwild <a href="tailwindcss.com">website</a>, this moving testimonial
        slider is an excellent example of modern UI that looks clean.
      </p>
    </div>
  </div>
  <div className="footer-container min-w-lg flex max-w-lg flex-row flex-nowrap justify-between rounded-b-lg bg-gradient-to-r from-green-400 to-blue-500 py-4 px-8">
    <div className="avatar-container">
      <div className="footer-img flex flex-row flex-nowrap">
        ...
        <div className="footer-text flex flex-col flex-nowrap">
          <p className="ml-6 font-bold text-gray-100">Manu Arora</p>
          <p className="ml-6 text-gray-200">Software Developer</p>
        </div>
      </div>
    </div>
    <div className="twitter-icon my-auto">
      <a href="https://twitter.com/mannupaaji">
        <svg width="33" height="32" fill="currentColor" className="text-gray-100">
