      ...
      <div className="divide divide-gray-200 px-2 dark:divide-gray-700 sm:px-0">
        <div className="grid grid-cols-1 space-y-10 py-4 sm:space-y-5 sm:py-14 xl:grid-cols-5">
          <div className="col-span-3 justify-center space-y-5 align-middle">
            <span className="relative inset-y-4 ml-24 inline-block px-1 before:absolute before:-inset-1 before:block before:-skew-y-6 before:rounded-lg before:bg-[#d97706] before:bg-opacity-20 sm:inset-y-7 sm:ml-40">
              <span className="relative inline-block -rotate-6 text-primary-500">
                <Link
                  href="https://twitter.com/bhanu527"
                  className="font-arrow2 text-sm font-bold text-[#ea580c] transition hover:underline hover:underline-offset-8 sm:text-xl"
                >
                  @bhanu527
                </Link>
              </span>
            ...
            <p className="text-black dark:text-white sm:pr-6 sm:text-lg sm:leading-8">
              ...
              building for the web & mobile. Also sometimes for the toaster. Have a good read!
